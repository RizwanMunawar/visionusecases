...
function loadGiscus() {
  ...
  script.setAttribute("data-repo", "RizwanMunawar/visionusecases");
  script.setAttribute("data-repo-id", "R_kgDONP3Uig");
  script.setAttribute("data-category", "Community");
  script.setAttribute("data-category-id", "DIC_kwDONP3Uis4CkXfq");
